...
var
  ...
  begin
    ret := pDSBuf.Lock(0, gSndBufSize, pbuf, dwSize, // VJ check params!
      pbuf2, dwSize2, 0);
    result := ret;
  end;
...
begin
  ...
  out_idx := (paintedtime * shm.channels) and out_mask; // VJ check priotities!
  step := 3 - shm.channels;
  snd_vol := int(volume.value * 256);
...
begin
  ...
  // clear the paint buffer
    Q_memset(@paintbuffer[0], 0, (_end - paintedtime) * SizeOf(portable_samplepair_t));
