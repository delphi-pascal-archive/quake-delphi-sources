...
{$ENDIF}
    ...
    begin
      ...
      Q_memcpy(@sock.receiveMessage[sock.receiveMessageLength], @packetBuffer.data, len);
...
begin
  ...
  begin
    ...
    Con_Printf('%s'#10'  frags:%3d  colors:%u %u  time:%u'#10'  %s'#10,
      [name, frags, colors div 16, colors and $0F, connectTime div 60, address]);
  end;
...
begin
  ...
  begin
    ...
    begin
      pvar := ConsoleVars.FindVar(prevCvarName);
      if pvar = nil then
      begin
        result := nil;
        exit;
